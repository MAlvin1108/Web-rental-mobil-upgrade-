      ...
      <table class="table table-hover">
          <tbody>
							...
							<?php while ($r = $query->fetch_assoc()): ?>
								...
								<tr>
        							<th>Tanggal Sewa</th>
        							<td>: <?= isset($r['tgl_sewa']) ? date("d-m-Y H:i:s", strtotime($r['tgl_sewa'])) : 'N/A' ?></td>
    							</tr>
								<tr>
									<th>Tanggal Ambil</th>
									<td>: <?=isset($r['tgl_ambil']) ? date("d-m-Y H:i:s", strtotime($r['tgl_ambil'])) : "<b>Belum</b>"?></td>
								</tr>
								<tr>
		  ...
		  <h5>NOTE!!</h5>
		  <p><strong>Jika telat mengembalikan akan dikenakan denda sebesar 10%/jam dari harga sewa mobil<strong></p>
      </table>
    </div>
